...
namespace ASPData.PlanningDTO
{
    public class PlanningDTO
    {
        ...
        public double FGsPlan { get; set; }
        public double MPsPlan { get; set; }
        public double FGsActual { get; set; }
        public int Year { get; set; }
        public int Month { get; set; }
        public string WODocNo { get; set; }
        public string ProductID { get; set; }
        public double ORDG { get; set; }
        public double ORVN { get; set; }
